...
# This module creates the control plane and worker node group
...
# EKS Cluster - the control plane (managed by AWS)
...
# EKS Node Group - the worker nodes (EC2 instances running your containers)
